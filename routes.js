        ...
        .then(data => {
          if(data.message === 'city not found' || data.message === 'wrong latitude' || data.message === 'wrong longitude'){
            ...
            res.render('meteo', {
              ...
              sunrise: (new Date((data.current.sunrise * 1000).getHours())+2) + ":" + new Date(data.current.sunrise).getMinutes(),
              sunset: (new Date((data.current.sunset * 1000).getHours())+2) + ":" + new Date(data.current.sunset).getMinutes()
            })
          }
        })
    } catch (err) {
          ...
          .then(data => {
            if(data.message === 'city not found' || data.message === 'wrong latitude' || data.message === 'wrong longitude'){
              ...
              res.render('meteo', {
                ...
                sunset: new Date(data.current.sunset * 1000).getHours() + ":" + new Date(data.current.sunset).getMinutes()
              })
            }
          })
      } catch (err) {
